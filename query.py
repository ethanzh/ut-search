...
def make_query(name):
    ...
    # If we've exceeded # of requests, terminate program
    if "You have exceeded the number of allowed requests" in return_html:
        print("Exceeded number of allowed requests")
        sys.exit()
